...
const ComponentToPrint = React.forwardRef(
  (
    ...
    //                 <td>{productData.productPacking}</td>
    //                 <td>{productData.productStrength}</td>
              ...
              {saleData?.map((item, index) => {
                return (
                  <tr key={index}>
                    ...
                    <td>{item?.batchCode}</td>
                    <td>{productData?.packing}</td>
                    <td>{productData?.strength}</td>
